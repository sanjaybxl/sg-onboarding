...
import Button from '../components/buttons/RoundedButton';
        ...
        return (
            <View pointerEvents="box-none" style={[styles.buttonWrapper, styles.fullScreen]}>
                {lastScreen
                    ...
                    ? <Button text="Start Now" handleOnPress={() => navigation.navigate("CreateUser")} />
                    // Or this one otherwise
                    : <Button text="Continue" handleOnPress={() => this.swipe()} />
                }
            </View>
        );
    }
